...
struct Inscription {
    ...
    int dossard;
    char vol[10];
    int note_jury_1, note_jury_2,note_jury_3;
    };
...
void competition(struct Inscription participant[],int nbp){
    int ndd;
 ...
 if(ndd == nbp || ndd < nbp) {
        printf("Saisir le temps de vol du participant : ");
            fflush(stdin);
            gets(participant[ndd].vol);
              printf("Saisir  la note artistique sur 10 du premier jury : ");
         fflush(stdin);
          scanf("%d", &participant[ndd].note_jury_1);
     printf("Saisir  la note artistique sur 10 du deuxieme jury : ");
         fflush(stdin);
          scanf("%d", &participant[ndd].note_jury_2);
                        printf("Saisir  la note artistique sur 10 du troisieme jury : ");
         fflush(stdin);
          scanf("%d", &participant[ndd].note_jury_3);

          printf("%d,  %s, %d, %d, %d", participant[ndd-1].dossard, participant[ndd].vol, participant[ndd].note_jury_1, participant[ndd].note_jury_2, participant[ndd].note_jury_3);
}
}
